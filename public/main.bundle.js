...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ngx_bootstrap_tooltip__ = __webpack_require__("../../../../ngx-bootstrap/tooltip/index.js");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        exports: [__WEBPACK_IMPORTED_MODULE_12_ngx_bootstrap_dropdown__["a" /* BsDropdownModule */], __WEBPACK_IMPORTED_MODULE_13_ngx_bootstrap_tooltip__["a" /* TooltipModule */], __WEBPACK_IMPORTED_MODULE_14_ngx_bootstrap_modal__["a" /* ModalModule */]],
...
module.exports = "<h2 class=\"page-header\">Be Grateful</h2>\n<p></p>\n<form (submit)=\"onGratefulSubmit()\">\n  <div class=\"form-group\">\n    <label>What will we be grateful for today?</label>\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"gratefulPost\" name=\"gratefulPost\">\n    <br>\n    <div class=\"container\">\n        <input type=\"submit\" value=\"Submit\">\n    </div>\n\n    <br />\n\n  </div>\n\n</form>\n\n<table class=\"table table-striped table-hover table-bordered\">\n  <thead class=\"thead-dark\">\n    <tr>\n      <th>#</th>\n      <th>I'm grateful for...</th>\n      <th>Edit/Delete</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr *ngFor=\"let post of getPosts\" name=\"post\">\n      <td>{{ post.createdOn }}</td>\n\n      <td>\n        <div class=\"col\">\n          {{ post.content }}\n        </div>\n      </td>\n      <td>\n        <div class=\"buttons\">\n          <button class=\"button-danger\" (click)= \"onDelete(post._id)\"> Delete  </button>\n          <!-- <button class=\"button-danger\" (click)= \"editting()\"> Edit  </button> -->\n        </div>\n      </td>\n    </tr>\n  </tbody>\n</table>\n"
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.gratefulGet = function () {
        var _this = this;
        var author = JSON.parse(localStorage.getItem('user'));
        this.authService.getPosts(author.name).subscribe(function (posts) {
            _this.getPosts = posts.posts;
        }, function (err) {
            console.log(err);
            return false;
        });
    };
    DashboardComponent.prototype.onGratefulSubmit = function () {
        var _this = this;
        var author = JSON.parse(localStorage.getItem('user'));
        var post = {
            author: author.name,
        ...
        this.authService.createPost(post).subscribe(function (data) {
            ...
            _this.gratefulGet();
            if (data.success) {
                _this.flashMessage.show('grateful for your efforts, thank you for your post', { cssClass: 'alert-success', timeout: 3000 });
            }
            else {
                _this.flashMessage.show('grateful for your efforts, but something went wrong', { cssClass: 'alert-danger', timeout: 3000 });
            }
        });
        this.gratefulPost = '';
    };
    DashboardComponent.prototype.onEdit = function (postId) {
        //coming soon!
    };
    DashboardComponent.prototype.onDelete = function (postId) {
        var _this = this;
        this.authService.deletePost(postId).subscribe(function (data) {
            console.log(data);
            if (data.success) {
                _this.gratefulGet();
                _this.flashMessage.show('grateful for your efforts, your post is deleted', { cssClass: 'alert-danger', timeout: 3000 });
            }
            else {
                _this.flashMessage.show('grateful for your efforts, your post is deleted', { cssClass: 'alert-danger', timeout: 3000 });
                _this.gratefulGet();
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Welcome to {{ title }}</h1>\n  <p class=\"lead\">A place to inspire. A place to get inspired </p>\n  <div >\n\n    <a\n      class=\"btn btn-danger\"\n      [routerLink] = \"['/login']\">\n      Login\n    </a>\n\n    <a\n      class=\"btn btn-primary\"\n      [routerLink] = \"['/register']\">\n      Register\n    </a>\n\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Consistently thinking</h3>\n    <p>Trying to come up with something you're grateful\n       for can be hard at first. This here, this is\n       your practice. It makes perfect.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Be inspired.</h3>\n    <p>Look to others for inspiration on thing to be\n      greatful for. Sometime you won't even realize\n      how many thing sthere are to be grateful for.</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Socialize</h3>\n    <p>Comment on other's gratefulness, share a similar\n      expereince, or just simply appreciate eachother,\n      together.</p>\n  </div>\n\n</div>\n"
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-default\">\n    <div class=\"container-fluid\">\n\n            <div class=\"navbar-header\">\n                <span class=\"navbar-brand noLink\">Grateful + Bound</span>\n            </div>\n\n\n\n              <div class=\"navbar-header link\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarTogglerDemo02\" aria-controls=\"navbarTogglerDemo02\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n                <div class=\"\">\n                  <div class=\"navbar-brand\">\n                    <a class=\"\">\n                      Grateful + Bound\n                    </a>\n                  </div>\n                </div>\n              </div>\n\n\n\n\n\n\n\n        <div class=\"navbar-collapse collapse\" id=\"navbarTogglerDemo02\">\n          <ul class=\"nav navbar-nav navbar-left\">\n            <li><a [routerLink] = \"['/']\">Home</a></li>\n          </ul>\n          <ul class=\"nav navbar-nav navbar-right\">\n            <li *ngIf=\"authService.loggedIn()\"><a [routerLink] = \"['/profile']\">\n              Profile</a>\n            </li>\n            <li *ngIf=\"authService.loggedIn()\"><a [routerLink] = \"['/dashboard']\">\n              Dashboard</a>\n            </li>\n            <li *ngIf=\"!authService.loggedIn()\"><a [routerLink] = \"['/login']\">\n              Login</a>\n            </li>\n            <li *ngIf=\"!authService.loggedIn()\"><a [routerLink] = \"['/register']\">\n              Register</a>\n            </li>\n            <li *ngIf=\"authService.loggedIn()\"><a (click)=\"onLogoutClick()\"[routerLink] = \"['/']\">\n              logout</a>\n            </li>\n          </ul>\n        </div>\n    </div>\n\n</nav>\n\n\n<!-- <nav class=\"navbar navbar-expand-lg navbar-light bg-light\">\n  <a class=\"navbar-brand\" href=\"#\">Navbar</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarTogglerDemo02\" aria-controls=\"navbarTogglerDemo02\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div class=\"collapse navbar-collapse\" id=\"navbarTogglerDemo02\">\n    <ul class=\"navbar-nav mr-auto mt-2 mt-lg-0\">\n      <li class=\"nav-item active\">\n        <a class=\"nav-link\" href=\"#\">Home <span class=\"sr-only\">(current)</span></a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link\" href=\"#\">Link</a>\n      </li>\n      <li class=\"nav-item\">\n        <a class=\"nav-link disabled\" href=\"#\">Disabled</a>\n      </li>\n    </ul>\n    <form class=\"form-inline my-2 my-lg-0\">\n      <input class=\"form-control mr-sm-2\" type=\"search\" placeholder=\"Search\">\n      <button class=\"btn btn-outline-success my-2 my-sm-0\" type=\"submit\">Search</button>\n    </form>\n  </div>\n</nav> -->\n"
...
var AuthService = (function () {
    ...
    AuthService.prototype.getPosts = function (userName) {
        ...
        headers.append('Content-Type', 'application/json');
        // dev
        var URL = 'http://localhost:3000/posts/' + userName;
